...
function UpdatePlant() {
  ...
  useEffect(() => {
    axios
      .get(API_URL + USER_SENSOR_LINKED_PLANTS, {
      ...
      .then((response) => {
        ...
        setSensorInfos(
          sensors
            .filter(
              (sensor: SensorLinkedToPlant) =>
                sensor.plantId === null || sensor.plantId === plantId,
            )
            .map((sensor: SensorLinkedToPlant) => ({
              id: sensor.sensorId,
    ...
    axios
      .get(API_URL + GENERAL_PLANTS_URL)
    ...
    <div className="min-h-screen w-full flex flex-col items-center">
      ...
      <div className="flex flex-col items-center justify-center flex-grow min-h-0">
        <div className="m-8 flex flex-col justify-center items-center w-full h-full">
          <UpdatePlantForm
            plantId={plantId}
            plantTypeOptions={plantTypes}
            sensorOptions={sensorInfos}
          />
        </div>
      </div>
    </div>
