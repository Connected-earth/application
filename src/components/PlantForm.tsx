...
function PlantForm({ plantTypeOptions, sensorOptions }: PlantFormProps) {
  ...
  const handleSubmit = async (event: { preventDefault: () => void }) => {
    ...
    axios
      .post(API_URL + USER_PLANTS_URL, newPlant, {
  ...
  return (
    <div className="box-content w-fit h-fit p-4 border border-black rounded-2xl">
      <form className="flex max-w-md flex-col gap-4" onSubmit={handleSubmit}>
        <div>
          <div>
            <label htmlFor="plantName" className={'pb-1'}>
              {' '}
              Plant type
            </label>
          </div>
          <select
            ...
            className={
              'block w-full text-sm text-gray-900 border border-gray-300 h-7 rounded-lg cursor-pointer focus:outline-none bg-white'
            }
            required
          >
        ...
        <div>
          ...
          <select
            ...
            className={
              'block w-full text-sm h-7 border border-gray-300 rounded-lg cursor-pointer focus:outline-none bg-white'
            }
            required
          >
        ...
        <div>
          ...
          <input
            ...
            type="text"
            className={
              'block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none bg-white h-7 placeholder:p-1 p-1'
            }
            placeholder={'name'}
            required
          />
        ...
        <div>
          ...
          <textarea
            ...
            id="remark"
            className={
              'block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none bg-white h-16 placeholder:p-1 p-1'
            }
            required
          />
        </div>
